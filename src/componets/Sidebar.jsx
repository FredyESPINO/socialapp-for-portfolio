...
// agregar o quitar border-black
const isActiveStyle='flex items-center px-5 gap-3 font-extrabold border-r-2  transition-all duration-200 ease-in-out capitalize border-black'
